...
class TargetGeometryCache:
    ...
    Holds only the frozen target T/Shape geometry needed by the all-class
    sample-class registration scan. It never stores target labels, classifier
    proposals, pseudo-labels or any derived phase-group state.
    """
